...
if ls *."$FILE_EXTENSION" >/dev/null 2>&1; then
    echo "Файлы с разрешением '$FILE_EXTENSION' найдены"
else
    echo "Ошибка: Файлы с расширением '$FILE_EXTENSION' в текущей директории не найдены."
    exit 1
fi
